...
import MyImage from "@/public/image1.jpg";
...
const MyProfile = () => {
  return (
    <>
    <div className="flex flex-col items-center gap-6 rounded-3xl bg-black pt-8 px-8 text-center md:flex-row md:items-center md:justify-start md:gap-8 md:text-left">
      {/* Image */}
